...
D16_D20.seu=FindClusters(D16_D20.seu, resolution = 0.1, algorithm = 1)
D16_D20.seu=FindClusters(D16_D20.seu, resolution = 0.2, algorithm = 1)
...
p & theme_bw()
#DimPlot(GFPneg_aggr, group.by = "seurat_clusters")
#Idents(GFPneg_aggr)=GFPneg_aggr$RNA_snn_res.0.2
#GFPneg_aggr=RenameIdents(GFPneg_aggr,"0"="C1","1"="C2","2"="C3","3"="C4","4"="C5","5"="C6","6"="C7","7"="C8","8"="C9","9"="C10")
#GFPneg_aggr$res_0.3=Idents(GFPneg_aggr)
#ggsave(umap_p,filename ="./output_data/UMAP_allcells_0802.pdf",width=7,heigh=6)
...
#D16_D20.seu$anno_1_f=factor(D16_D20.seu$anno_1,levels = c("iStroma","iEndo","Hematopoietic_progenitor","iMkE","iMyeloid","iCLP/iNKP","im-iNK"))
